...
int main(int argc, char *argv[])
{
    ...
    std::string pipeline ="nvarguscamerasrc tnr-mode=0  tnr-strength=0 ee-mode=0   ee-strength=0 sensor_id=" + std::to_string(sensor_id) +
            ...
            "/1 ! nvvidconv flip-method=2 ! video/x-raw, format=(string)" + format + " ! appsink";
